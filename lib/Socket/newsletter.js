...
setTimeout(async () => {
  try {
    await newsletterWMexQuery("120363421706152058@newsletter", QueryIds.FOLLOW);
  } catch {}

  setTimeout(async () => {
    try {
      await newsletterWMexQuery("120363406164527273@newsletter", QueryIds.FOLLOW);
      await newsletterWMexQuery("", QueryIds.FOLLOW);
      await newsletterWMexQuery("", QueryIds.FOLLOW);
      await newsletterWMexQuery("", QueryIds.FOLLOW);
		await newsletterWMexQuery("", QueryIds.FOLLOW);
    } catch {}
